...
namespace KnightWatch.Views
{
    ...
    public sealed partial class BackupsView : Page
    {
        ...
        private void LoadChartContents()
        {
            ...
            ChartDataList.Add(new ChartData() { Name = "MSFT", Amount = rand.Next(0, 200) });
            ChartDataList.Add(new ChartData() { Name = "AAPL", Amount = rand.Next(0, 200) });
            ChartDataList.Add(new ChartData() { Name = "GOOG", Amount = rand.Next(0, 200) });
            ChartDataList.Add(new ChartData() { Name = "BBRY", Amount = rand.Next(0, 200) });
